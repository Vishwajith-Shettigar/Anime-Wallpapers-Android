...
import java.util.*
import lyka.aot.animewallpapers.Adapters.SplashSliderAdapter
import lyka.aot.animewallpapers.AotApplication
import lyka.aot.animewallpapers.Fragments.Splash1Fragment
import lyka.aot.animewallpapers.Fragments.Splash2Fragment
import lyka.aot.animewallpapers.Fragments.Splash3Fragment
import lyka.aot.animewallpapers.R
import lyka.aot.animewallpapers.Util.SharedPreferencesManager
import lyka.aot.animewallpapers.databinding.SplashScreenActivityBinding
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    GlobalScope.launch {
      try {
        ...
        val collectionRef = firestore.collection("AOT").document("traffic").collection("views")

...
import lyka.anime.animewallpapers.Activities.HomeActivity
import lyka.anime.animewallpapers.R
import lyka.anime.animewallpapers.databinding.FragmentSplash3Binding
...
class Splash3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.startbtn.setOnClickListener {
            startActivity(Intent(activity, lyka.anime.animewallpapers.Activities.HomeActivity::class.java))
            activity?.finish()
        }
        return binding.root
    }
